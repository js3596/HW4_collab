...
class EkfSlam(Ekf):
    ...
    def transition_model(self, u, dt):
        ...
        g[0:3], Gx[0:3,0:3], Gu[0:3,:] = tb.compute_dynamics(self.x[0:3], u, dt)
    ...
    def compute_predicted_measurements(self):
        ...
        for j in range(J):
            ...
            h, Hx[:,0:3] = tb.transform_line_to_scanner_frame([alpha, r], self.x[0:3], self.tf_base_to_camera)
            ...
            if j >= 2:
                ...
                x_cb = self.tf_base_to_camera[0]
                y_cb = self.tf_base_to_camera[1]
                x = self.x[0]
                y = self.x[1]
                theta = self.x[2]
